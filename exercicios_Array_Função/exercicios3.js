...
// Resoluçao
function calcularSalarioLiquido(horasTrabalhada, ganhoPorHora) {
    const salarioButo = horasTrabalhada * ganhoPorHora
    const salarioLiquido = salarioButo - salarioButo * 30/100
